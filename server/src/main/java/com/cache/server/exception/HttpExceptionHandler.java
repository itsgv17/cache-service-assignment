...
public class HttpExceptionHandler {
	...
	public ResponseEntity<ExceptionResponseList> noHandlerFoundException(final NoHandlerFoundException ex) {
		...
		return new ResponseEntity<>(new ExceptionResponseList(Arrays.asList(response)), HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<ExceptionResponseList> missingRequestHeaderException(final MissingRequestHeaderException ex) {

		final String error = "Missing request header " + ex.getHeaderName();
